<section id="sectionModelPin" class="relative h-[200vh]">
    ...
    <div class="sticky left-0 right-0 bottom-0 h-screen w-full z-10">
        ...
        <model-viewer id="model-viewer" src="{{ asset('assets/3d/model_girl.glb') }}" ar disable-zoom
            camera-orbit="0deg 90deg 10m" camera-target="3m 3m 3m" field-of-view="30deg" auto-rotate
            class="w-full h-full">
        </model-viewer>
